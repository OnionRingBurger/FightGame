...
PolylineEffect::LineID PolylineEffect::AddLine(int controlPointNum, DirectX::XMFLOAT3 startPos)
{
	...
	InitControlPoints(static_cast<LineID>(m_lines.size()), line.controlPoints, startPos);
...
*/
void PolylineEffect::InitControlPoints(LineID id, ControlPoints& controlPoints, DirectX::XMFLOAT3 startPos)
{
