...
SoundMap				g_soundMap;
std::vector<IXAudio2SourceVoice*> g_source;
...
void UninitSound(void)
{
	...
	// サウンドデータの削除
	for (auto& it : g_soundMap)
	{
		SAFE_DELETE_ARRAY(it.second.pBuffer);
	}
	g_soundMap.clear();
 ...
 */
bool PlaySound(XAUDIO2_BUFFER* pSound)
{
	HRESULT hr;
