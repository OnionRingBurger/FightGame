...
* @date 2026.12.05 Maya,Assimpのバージョン変更に対応
* @brief 
* @ 合成アニメーションとは(そのうち追記
* 
*/
...
public:
	...
	{
		None,			// DirectX準拠(反転する
		XFlip,			// 左右の入れ替え(Z軸が左手系と一致したまま
		ZFlip,			// 前後の入れ替え(X軸が左手系と一致したまま
		XZFlip,			// 
...
public:
	...
	*/
	...
	void DrawAlphaBlend(Texture* texture1, Texture* texture2, int meshNo = -1);
