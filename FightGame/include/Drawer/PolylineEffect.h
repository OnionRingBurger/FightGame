...
public:	
	...
	LineID AddLine(int controlPointNum, DirectX::XMFLOAT3 startPos);
...
protected:
	// 制御点の初期化
	virtual void InitControlPoints(LineID id, ControlPoints& controlPoints, DirectX::XMFLOAT3 startPos);
	// 制御点の更新処理
